...
public class MiniCobolPerformFromImpl extends ASTWrapperPsiElement implements MiniCobolPerformFrom {

  public MiniCobolPerformFromImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniCobolVisitor visitor) {
    visitor.visitPerformFrom(this);
  }
