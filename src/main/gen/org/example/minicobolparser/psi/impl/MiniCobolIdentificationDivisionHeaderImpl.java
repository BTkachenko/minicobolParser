...
public class MiniCobolIdentificationDivisionHeaderImpl extends ASTWrapperPsiElement implements MiniCobolIdentificationDivisionHeader {

  public MiniCobolIdentificationDivisionHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniCobolVisitor visitor) {
    visitor.visitIdentificationDivisionHeader(this);
  }
