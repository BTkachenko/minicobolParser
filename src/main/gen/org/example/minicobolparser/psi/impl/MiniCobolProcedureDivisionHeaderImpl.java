...
public class MiniCobolProcedureDivisionHeaderImpl extends ASTWrapperPsiElement implements MiniCobolProcedureDivisionHeader {

  public MiniCobolProcedureDivisionHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniCobolVisitor visitor) {
    visitor.visitProcedureDivisionHeader(this);
  }
