...
public class MiniCobolPerformStatementImpl extends ASTWrapperPsiElement implements MiniCobolPerformStatement {

  public MiniCobolPerformStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MiniCobolPerformVaryingPhrase getPerformVaryingPhrase() {
    return findNotNullChildByClass(MiniCobolPerformVaryingPhrase.class);
  }
