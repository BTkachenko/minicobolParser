...
public class MiniCobolRelationalOperatorImpl extends ASTWrapperPsiElement implements MiniCobolRelationalOperator {

  public MiniCobolRelationalOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
