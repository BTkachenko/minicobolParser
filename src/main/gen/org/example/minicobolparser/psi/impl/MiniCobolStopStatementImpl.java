...
public class MiniCobolStopStatementImpl extends ASTWrapperPsiElement implements MiniCobolStopStatement {

  public MiniCobolStopStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
