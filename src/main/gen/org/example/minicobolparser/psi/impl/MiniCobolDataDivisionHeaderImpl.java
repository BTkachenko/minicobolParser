...
public class MiniCobolDataDivisionHeaderImpl extends ASTWrapperPsiElement implements MiniCobolDataDivisionHeader {

  public MiniCobolDataDivisionHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniCobolVisitor visitor) {
    visitor.visitDataDivisionHeader(this);
  }
