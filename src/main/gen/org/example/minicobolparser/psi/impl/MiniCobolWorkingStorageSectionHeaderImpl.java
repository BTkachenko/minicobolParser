...
public class MiniCobolWorkingStorageSectionHeaderImpl extends ASTWrapperPsiElement implements MiniCobolWorkingStorageSectionHeader {

  public MiniCobolWorkingStorageSectionHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniCobolVisitor visitor) {
    visitor.visitWorkingStorageSectionHeader(this);
  }
