...
public class MiniCobolParagraphHeaderImpl extends ASTWrapperPsiElement implements MiniCobolParagraphHeader {

  public MiniCobolParagraphHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }
