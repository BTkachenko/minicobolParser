...
public class MiniCobolProcedureDivisionImpl extends ASTWrapperPsiElement implements MiniCobolProcedureDivision {

  public MiniCobolProcedureDivisionImpl(@NotNull ASTNode node) {
    super(node);
  }
