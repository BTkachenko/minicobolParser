...
public class MiniCobolArithmeticExpressionImpl extends ASTWrapperPsiElement implements MiniCobolArithmeticExpression {

  public MiniCobolArithmeticExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
