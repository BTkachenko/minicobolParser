...
public class MiniCobolDataDivisionImpl extends ASTWrapperPsiElement implements MiniCobolDataDivision {

  public MiniCobolDataDivisionImpl(@NotNull ASTNode node) {
    super(node);
  }
