...
public class MiniCobolPerformTestPhraseImpl extends ASTWrapperPsiElement implements MiniCobolPerformTestPhrase {

  public MiniCobolPerformTestPhraseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniCobolVisitor visitor) {
    visitor.visitPerformTestPhrase(this);
  }
