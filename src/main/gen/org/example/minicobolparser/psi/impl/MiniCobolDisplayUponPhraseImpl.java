...
public class MiniCobolDisplayUponPhraseImpl extends ASTWrapperPsiElement implements MiniCobolDisplayUponPhrase {

  public MiniCobolDisplayUponPhraseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniCobolVisitor visitor) {
    visitor.visitDisplayUponPhrase(this);
  }
