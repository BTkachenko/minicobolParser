...
public class MiniCobolPictureClauseImpl extends ASTWrapperPsiElement implements MiniCobolPictureClause {

  public MiniCobolPictureClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MiniCobolPictureString getPictureString() {
    return findNotNullChildByClass(MiniCobolPictureString.class);
  }
