...
public class MiniCobolPerformByImpl extends ASTWrapperPsiElement implements MiniCobolPerformBy {

  public MiniCobolPerformByImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniCobolVisitor visitor) {
    visitor.visitPerformBy(this);
  }
