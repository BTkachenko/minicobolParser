...
public class MiniCobolIdentificationDivisionImpl extends ASTWrapperPsiElement implements MiniCobolIdentificationDivision {

  public MiniCobolIdentificationDivisionImpl(@NotNull ASTNode node) {
    super(node);
  }
