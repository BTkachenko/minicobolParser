...
public class MiniCobolLevelNumberImpl extends ASTWrapperPsiElement implements MiniCobolLevelNumber {

  public MiniCobolLevelNumberImpl(@NotNull ASTNode node) {
    super(node);
  }
