...
public class MiniCobolDataValueClauseImpl extends ASTWrapperPsiElement implements MiniCobolDataValueClause {

  public MiniCobolDataValueClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MiniCobolLiteral getLiteral() {
    return findNotNullChildByClass(MiniCobolLiteral.class);
  }
