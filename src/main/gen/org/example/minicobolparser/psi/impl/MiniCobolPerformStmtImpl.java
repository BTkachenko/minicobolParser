...
public class MiniCobolPerformStmtImpl extends ASTWrapperPsiElement implements MiniCobolPerformStmt {

  public MiniCobolPerformStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
