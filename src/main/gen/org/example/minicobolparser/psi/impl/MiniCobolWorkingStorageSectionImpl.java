...
public class MiniCobolWorkingStorageSectionImpl extends ASTWrapperPsiElement implements MiniCobolWorkingStorageSection {

  public MiniCobolWorkingStorageSectionImpl(@NotNull ASTNode node) {
    super(node);
  }
