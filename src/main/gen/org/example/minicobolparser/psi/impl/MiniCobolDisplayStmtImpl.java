...
public class MiniCobolDisplayStmtImpl extends ASTWrapperPsiElement implements MiniCobolDisplayStmt {

  public MiniCobolDisplayStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
