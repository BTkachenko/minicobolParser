...
public class MiniCobolProgramIdHeaderImpl extends ASTWrapperPsiElement implements MiniCobolProgramIdHeader {

  public MiniCobolProgramIdHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniCobolVisitor visitor) {
    visitor.visitProgramIdHeader(this);
  }
